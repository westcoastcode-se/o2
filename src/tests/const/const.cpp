...
void const_()
{
	...
	suite("const", []()
	{
		test("const_global", ROOT_PATH, [](syntax_tree& st)
		{
			...
			const auto var_INT = assert_type<node_named_variable>(root->get_child(14));
			...
			const auto var_INT2 = assert_type<node_named_variable>(root->get_child(15));
			...
			const auto var_FLOAT = assert_type<node_named_variable>(root->get_child(16));
			...
			const auto var_FLOAT2 = assert_type<node_named_variable>(root->get_child(17));
